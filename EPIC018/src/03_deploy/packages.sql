...
--epic018 - paquetes de transacciones del cliente
spool ./src/03_deploy/packages/packages_loop.sql;
PROMPT var codclavecic number;

begin
  for target_pointer in (select distinct codclavecic, codunicocli, numperiodo as codmes from tmp_ingcashbcacei_alertas )
  loop
...
/*
--epic018 - paquetes de eecc del cliente

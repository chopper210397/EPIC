...
--epic001 - paquetes de transacciones del cliente
spool ./src/03_deploy/packages/packages_loop.sql;
PROMPT var codclavecic number;

begin
  for target_pointer in (select distinct codclavecic, codunicocli, periodo as codmes from tmp_retatmext_alertas )
  loop
...
/*
--epic001 - paquetes de eecc del cliente

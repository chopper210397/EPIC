# **EPIC021 - Escenario Agente**

- *Desarrollado por: Jorge Del Rio, Marcelo Mamani, Rodrigo Maldonado*
- *Fecha de producción: Diciembre 2020*

## 1. Objetivo

Identificar operaciones inusuales realizadas mediante el canal Agente.

## 2. Documentación

- [Ficha tecnica](https://confluence.devsecopsbcp.com/pages/viewpage.action?pageId=636057981)
- [Manual Metodológico](https://confluence.devsecopsbcp.com/pages/viewpage.action?pageId=636057521)
- [Anexos](https://confluence.devsecopsbcp.com/display/CUMPPRIVAD/EPIC021+-+Anexos)
...
- *S55632.RM_EQUIVAL_TIPOPE_EECC_TMP (Miguel Tasayco)*
...
2. Se deberá validar que se haya escrito el seguimiento del mes ejecutado en la ruta: `<code>`SEGUIMIENTO_VARIABLES/Temporal/RESULTADOS_2023XX.xlsx `</code>`d

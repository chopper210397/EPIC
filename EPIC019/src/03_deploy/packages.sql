...
--EPIC019 - Paquetes de transacciones del cliente
...
BEGIN
  FOR TARGET_POINTER IN (SELECT DISTINCT codclavecic, codunicocli FROM TMP_EPIC019 UNION ALL SELECT 1008160 CODCLAVECIC, '180749071' CODUNICOCLI FROM DUAL)
  LOOP

...
begin
  for target_pointer in (select distinct codclavecic, codunicocli, periodo as codmes from tmp_ingresotrc_alertaspj )
  loop
    ...
    dbms_output.put_line('@@./src/03_deploy/packages/packages_trx1.sql;');
  end loop;
end;
/
spool off;

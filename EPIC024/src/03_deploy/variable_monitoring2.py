...
class Seguimiento:
    ...
    def load_data(self):
        ...
        try:
            df_actual = pd.read_csv(r"./data/production/02_preprocessed_ppnn.csv",
                                    encoding= "latin-1",sep="|")
            df_desarrollo = pd.read_csv(r"./data/modeling/02_preprocessed_ppnn.csv",
                                        encoding= "latin",sep="|")
        except FileNotFoundError:
            logging.warning("No existe el archivo 02_preprocessed_ppnn.csv")
            sys.exit()
    ...
    def output(self,modelo,salida, periodo):
        ...
        try:
            ...
            nombre_file = "RESULTADOS_PPNN_"+modelo+"_"+str(periodo)+".xlsx"

# **EPIC024_Estructuración a través de Pagos del Exterior**

- *Desarrollado por:  Maria Mallaupoma*
- *Producción: Ashly Aguilar*
- *Fecha de producción: Diciembre 2023*

---

## 1. Objetivo

Identificar clientes con ingresos estructurados por montos similares.

## 2. Documentación

- [Ficha tecnica](https://confluence.devsecopsbcp.com/pages/viewpage.action?pageId=656814567)
- [Manual Metodológico](https://confluence.devsecopsbcp.com/pages/viewpage.action?pageId=656806511)
- [Anexos](https://confluence.devsecopsbcp.com/pages/viewpage.action?pageId=655868494)
...
1. Deberá crear el archivo *03_deploy/packages/packages_loop.sql* ya que este archivo no se trackea con Git.

# **EPIC020 - Perfil de egresos para Banca Corporativa, Empresa e Institucional**

- *Desarrollado por: Marcelo Mamani, Alvaro Vasquez*
- *Fecha de producción: Setiembre 2020*

---

## 1. Objetivo

Identificar clientes de la banca Corporativo, Empresa e Institucional que salen de su perfil transaccional de egresos.

## 2. Documentación

- [Ficha tecnica](https://confluence.lima.bcp.com.pe/pages/viewpage.action?pageId=636049878)
- [Manual Metodológico](https://confluence.lima.bcp.com.pe/pages/viewpage.action?pageId=636049826)
- [Anexos](https://confluence.lima.bcp.com.pe/display/CUMPPRIVAD/EPIC020+-+Anexos)
...
- *S61751.SAPY_DM_ALERTA (Antony Ortiz)*
- *S55632.CLIBCP_ACTUAL_TOTAL (Miguel Tasayco)*
...
2. Dentro de la carpeta **Data** de **SEGUIMIENTO_VARIABLES** crear la carpeta **EPIC020** y dentro incluir los archivos **02_preprocessed.csv** y **04_predicted.csv** que se encuentran en la parte final de los **Anexos** en la sección **e. Data de validación**

...
if entorno == "production":
    ruta_modelo = r'.\src\03_models\IF_MEpic16.model'
    ruta_data_produccion = r".\data\production\01_raw.csv"
    ruta_data_entrenamiento = r'..\SEGUIMIENTO_VARIABLES\Data\EPIC016\02_preprocessed.csv'
    ruta_train_predicted = r'..\SEGUIMIENTO_VARIABLES\Data\EPIC016\04_predicted.csv'
    ...
    ruta_modelo = r'EPIC016\src\03_models\IF_MEpic16.model' # Esto siempre esta dentro de la epic en bitbucket
    ruta_data_produccion = r"EPIC016\data\production\01_raw.csv" # Esto siempre esta dentro de la epic en bitbucket cuando está en producción
    ruta_data_entrenamiento = r'SEGUIMIENTO_VARIABLES\Data\EPIC016\02_preprocessed.csv' # Esto nosotros lo ponemos para cada EPIC
    ruta_train_predicted = r'SEGUIMIENTO_VARIABLES\Data\EPIC016\04_predicted.csv' # Esto nosotros lo ponemos para cada EPIC
...
variables_modelo= ['MTO_INGRESOS', 'POR_CASH', 'FLG_PERFIL_3DESVT_TRX', 'FLG_ANLSBNP']
columnas_numericas = ['MTO_INGRESOS', 'POR_CASH']
columnas_categoricas = ['FLG_PERFIL_3DESVT_TRX', 'FLG_ANLSBNP']
...
df_entrenamiento_scoreado = df_entrenamiento_scoreado.rename(columns={'IF_LABEL': columna_clusters})

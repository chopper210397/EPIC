...
if entorno == "production":
    ...
    ruta_data_entrenamiento = r'..\SEGUIMIENTO_VARIABLES\Data\EPIC014\02_preprocessed.csv'
    ruta_train_predicted = r'..\SEGUIMIENTO_VARIABLES\Data\EPIC014\04_predicted.csv'
    ...
    ruta_modelo = r'EPIC014\src\02_models\kmeans_model_39.model' # Esto siempre esta dentro de la epic en bitbucket
    ruta_data_produccion = r"EPIC014\data\production\01_raw.csv" # Esto siempre esta dentro de la epic en bitbucket cuando está en producción
    ruta_data_entrenamiento = r'SEGUIMIENTO_VARIABLES\Data\EPIC014\02_preprocessed.csv' # Esto nosotros lo ponemos para cada EPIC
    ruta_train_predicted = r'SEGUIMIENTO_VARIABLES\Data\EPIC014\04_predicted.csv' # Esto nosotros lo ponemos para cada EPIC
...
variables_modelo= ['MTO_RECIBIDO', 'FLG_ROS_REL', 'FLG_LSB_NP_REL', 'FLG_PERFIL_3DESVT_TRX']
columnas_numericas = ['MTO_RECIBIDO']
columnas_categoricas = ['FLG_ROS_REL', 'FLG_LSB_NP_REL', 'FLG_PERFIL_3DESVT_TRX']
